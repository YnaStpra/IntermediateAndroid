...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  private ActivityWelcomeBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout background, @NonNull Guideline guidelineHorizontal,
      @NonNull Guideline guidelineVertical, @NonNull ImageView imageView,
      @NonNull Button loginButton, @NonNull ProgressBar progressBar, @NonNull Button signupButton,
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWelcomeBinding((ConstraintLayout) rootView, background,
          guidelineHorizontal, guidelineVertical, imageView, loginButton, progressBar, signupButton,
          titleTextView);
    }
